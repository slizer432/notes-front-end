...
const Sidebar = () => {
  return (
    <aside className="bg-neutral-900 text-white w-[35vh] h-screen py-10 border-r border-zinc-700 flex flex-col">
      <div className="px-5">
      ...
      <div className="absolute w-[inherit] border-t border-zinc-700 bottom-0 p-4 flex items-center">
        <User />
